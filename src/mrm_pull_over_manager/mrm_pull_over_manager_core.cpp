...
void MrmPullOverManager::on_map(const LaneletMapBin::ConstSharedPtr msg)
{
  ...
  const std::vector<geometry_msgs::msg::Pose> & poses)
{
  ...
  for (; it != poses.end(); ++it) {
    ...
    const double yaw_deviation = autoware::motion_utils::calcYawDeviation(trajectory_->points, *it);
    ...
    const double arc_length_to_pose = autoware::motion_utils::calcSignedArcLength(
